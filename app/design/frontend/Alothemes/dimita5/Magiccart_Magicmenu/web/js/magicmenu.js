        ...
        $.fn.magicmenu = function (options) {
            ...
            var methods    = {
                ...
                sticky: function(topmenu){
                    ...
                    var slideHeight = $('.slide-showcase.static-home-slide').innerHeight();
                    var menuHeight  = menuSticky.innerHeight(),
                        sumMenuSlide = menuHeight+slideHeight ;
                    ...
                    $(window).scroll(function () {
                        ...
                        if (postion > sumMenuSlide){ /* not use = */
                ...
                toggleVertical: function ($vmenu) {
                    $vmenu.find('.v-title').click(function() {
                        ...
                        $('body').hasClass('cms-index-index') ?  $(this).off('click') : $vmenu.find('.nav-desktop').height('').slideToggle(400);
